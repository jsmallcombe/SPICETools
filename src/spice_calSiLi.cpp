...
// 	hist->Rebin(2);
	...
	FullFitHolder* fitA=Ultrapeak::PeakFit(hist,AA-50./gain,AA+(BiPeaks[2]-BiPeaks[0]+50)/gain,fInput,4,0,0,ss.str());
	FullFitHolder* fitB=Ultrapeak::PeakFit(hist,BB-50./gain,BB+(BiPeaks[5]-BiPeaks[3]+50)/gain,fInputB,4,0,0,ss.str());
