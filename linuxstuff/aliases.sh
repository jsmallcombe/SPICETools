...
alias rot='\root -n -l'
alias root='root -l'
alias grsi='/home/$(whoami)/GRSISort/bin/grsisort -l'
alias tbro='bash ~/Dropbox/codes/linuxstuff/newBrowser.sh'
alias fbro='bash ~/Dropbox/codes/linuxstuff/newFBrowser.sh'

alias rachel='python /home/$(whoami)/Gosia/source/Rachel-master/rachel.py'
...
alias liverpool='ssh js@ns.ph.liv.ac.uk'
